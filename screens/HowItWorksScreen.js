      ...
      <View isSafe style={styles.container}>
        <ScrollView>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.screenTitle}>Quer saber quanto tempo ainda lhe resta?</Text>
          </View>
          <Text style={styles.footerText}>
            Com o Death Date você pode saber quanto tempo ainda lhe resta de vida, basta preencher os campos, aguardar pelos resultados e curtir o resto de vida que ainda lhe resta. 
          </Text>
          <Text style={styles.footerText}>
